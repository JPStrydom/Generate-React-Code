...
export default class SomeCompleteTemplateView extends Component {
    constructor(props) {
        super(props);
    ...
    render() {
        return <div className="some-complete-template">{this.renderTextExample()}</div>;
    }
...
in this module.
*/
SomeCompleteTemplateView.propTypes = {
